...
#
# JARVIS_BRAIN_SEARCH_TIMEOUT: Max seconds to wait for brain classification and
#   web search prefetch. Prevents indefinite block if brain or Tavily hangs.
...
class ChatService:
    ...
    def __init__(
        ...
        Args:
            ...
            brain_service: The Groq-powered brain that classifies queries as
                           general or realtime. Used only for process_jarvis_message_stream.
                           If None, Jarvis mode will default to realtime.
    ...
    def process_jarvis_message_stream(
        ...
        """
        Unified Jarvis route: brain classifies the query, then routes to general
